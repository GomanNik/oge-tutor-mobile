...
export const INITIAL_DATA = {
  ...
  students: [
    {
      ...
      progressByTask: [
        ...
        progressEntry(5, PROGRESS_COVERAGE_STATUS.IN_PROGRESS, null, { lessonCount: 1, lastLessonId: 'l-1', lastActivityAt: '2026-07-05T16:30:00.000Z', source: PROGRESS_SOURCE.LESSON_COMPLETED }),
        progressEntry(7, PROGRESS_COVERAGE_STATUS.ASSESSMENT_NEEDED, null, { lessonCount: 2, lastLessonId: 'l-1', lastActivityAt: '2026-07-05T16:30:00.000Z', source: PROGRESS_SOURCE.LESSON_COMPLETED, history: [assessmentEvent('pe-s1-7-l1', 7, 'l-1', '2026-07-05T16:30:00.000Z')] }),
        progressEntry(17, PROGRESS_COVERAGE_STATUS.ASSESSED, PROGRESS_MASTERY_LEVEL.WEAK, { lessonCount: 1, lastLessonId: 'l-4', lastActivityAt: '2026-07-01T16:00:00.000Z', lastAssessedAt: '2026-07-02T18:00:00.000Z', source: PROGRESS_SOURCE.HOMEWORK_RESULT, teacherComment: 'Нужно аккуратнее работать с углами.', recommendedAction: 'Повторить окружность и углы.' }),
    ...
    },
    {
      ...
      progressByTask: [
        ...
        progressEntry(6, PROGRESS_COVERAGE_STATUS.ASSESSMENT_NEEDED, null, { lessonCount: 1, lastLessonId: 'l-2', lastActivityAt: '2026-07-06T14:30:00.000Z', source: PROGRESS_SOURCE.LESSON_COMPLETED, history: [assessmentEvent('pe-s2-6-l2', 6, 'l-2', '2026-07-06T14:30:00.000Z')] }),
        progressEntry(7, PROGRESS_COVERAGE_STATUS.ASSESSED, PROGRESS_MASTERY_LEVEL.GOOD, { lessonCount: 1, lastLessonId: 'l-2', lastActivityAt: '2026-07-06T14:30:00.000Z', lastAssessedAt: '2026-07-06T16:00:00.000Z', source: PROGRESS_SOURCE.MANUAL }),
        progressEntry(8, PROGRESS_COVERAGE_STATUS.IN_PROGRESS, null, { lessonCount: 1, lastLessonId: 'l-2', lastActivityAt: '2026-07-06T14:30:00.000Z', source: PROGRESS_SOURCE.LESSON_COMPLETED }),
    ...
    },
    {
      ...
      progressByTask: [
        ...
        progressEntry(21, PROGRESS_COVERAGE_STATUS.IN_PROGRESS, null, { lessonCount: 1, lastLessonId: 'l-3', lastActivityAt: '2026-07-08T17:00:00.000Z', source: PROGRESS_SOURCE.LESSON_COMPLETED }),
  ...
  lessons: [
    { id: 'l-1', teacherId: TEACHER_ID, studentId: 's-1', startAt: '2026-07-05T16:30:00.000Z', endAt: '2026-07-05T17:30:00.000Z', timezone: 'Europe/Moscow', durationMinutes: 60, topic: 'Уравнения и неравенства', focusTaskNumbers: [5, 7], status: LESSON_STATUS.PLANNED, source: LESSON_SOURCE.MANUAL, note: '', materials: [libraryAttachment('la-1', 7, 'Неравенства', 'Неравенства: Правила.pdf'), linkAttachment('la-2', 'Видеоразбор к уроку', 'https://example.com/lesson')], createdAt: '2026-07-01T08:00:00.000Z', updatedAt: '2026-07-01T08:00:00.000Z' },
    { id: 'l-2', teacherId: TEACHER_ID, studentId: 's-2', startAt: '2026-07-06T14:30:00.000Z', endAt: '2026-07-06T15:30:00.000Z', timezone: 'Europe/Moscow', durationMinutes: 60, topic: 'Задания 6–8', focusTaskNumbers: [6, 7, 8], status: LESSON_STATUS.RESCHEDULED, source: LESSON_SOURCE.MANUAL, note: 'Перенесли по просьбе ученика.', materials: [], createdAt: '2026-07-01T08:00:00.000Z', updatedAt: '2026-07-04T08:00:00.000Z' },
    { id: 'l-3', teacherId: TEACHER_ID, studentId: 's-3', startAt: '2026-07-08T16:00:00.000Z', endAt: '2026-07-08T17:00:00.000Z', timezone: 'Europe/Moscow', durationMinutes: 60, topic: 'Текстовые задачи', focusTaskNumbers: [21], status: LESSON_STATUS.PLANNED, source: LESSON_SOURCE.MANUAL, note: '', materials: [], createdAt: '2026-07-01T08:00:00.000Z', updatedAt: '2026-07-01T08:00:00.000Z' },
    { id: 'l-4', teacherId: TEACHER_ID, studentId: 's-1', startAt: '2026-07-01T15:00:00.000Z', endAt: '2026-07-01T16:00:00.000Z', timezone: 'Europe/Moscow', durationMinutes: 60, topic: 'Геометрия', focusTaskNumbers: [17], completedAt: '2026-07-01T16:00:00.000Z', completionComment: 'Повторили окружность и углы.', status: LESSON_STATUS.COMPLETED, source: LESSON_SOURCE.MANUAL, note: '', materials: [libraryAttachment('la-3', 17, 'Геометрия', 'Геометрия: Разбор задания 17.pdf')], createdAt: '2026-07-01T08:00:00.000Z', updatedAt: '2026-07-01T16:00:00.000Z' },
  ],
  materials: [
  ...
  homeworks: [
    {
      ...
      assignedAt: '2026-07-02T08:00:00.000Z', dueAt: '2026-07-06T20:59:00.000Z', status: HOMEWORK_STATUS.SUBMITTED, description: 'Решить задания 1–5 из варианта и загрузить фото или PDF с решением.',
      solutionFile: 'variant-7-solution.pdf', submittedAt: '2026-07-04T15:40:00.000Z', reviewedAt: '', closedAt: '',
      attempts: [{ id: 'att-1', homeworkId: 'hw-1', studentId: 's-1', file: 'variant-7-solution.pdf', fileResource: fileAttachment('sf-1', 'variant-7-solution.pdf', { uploadedAt: '2026-07-04T15:40:00.000Z' }), submittedAt: '2026-07-04T15:40:00.000Z', reviewStatus: SUBMISSION_STATUS.SUBMITTED }],
      teacherComment: '',
      materials: [libraryAttachment('ha-1', 1, 'Задания 1–5', 'Теория по заданиям 1–5'), fileAttachment('ha-2', 'Пример оформления решения.pdf')],
      reviewMaterials: [], createdAt: '2026-07-02T08:00:00.000Z', updatedAt: '2026-07-04T15:40:00.000Z',
    },
    {
      id: 'hw-2', teacherId: TEACHER_ID, studentId: 's-1', title: 'Геометрия: задание 17', topic: 'Задание 17', taskNumbers: [17],
      assignedAt: '2026-06-29T08:00:00.000Z', dueAt: '2026-07-02T20:59:00.000Z', status: HOMEWORK_STATUS.REVIEWED, description: 'Повторить свойства окружности и решить подборку задач по геометрии.',
      solutionFile: 'geometry-17.pdf', submittedAt: '2026-07-02T16:15:00.000Z', reviewedAt: '2026-07-02T18:00:00.000Z', closedAt: '2026-07-02T18:00:00.000Z',
      attempts: [{ id: 'att-2', homeworkId: 'hw-2', studentId: 's-1', file: 'geometry-17.pdf', fileResource: fileAttachment('sf-2', 'geometry-17.pdf', { uploadedAt: '2026-07-02T16:15:00.000Z' }), submittedAt: '2026-07-02T16:15:00.000Z', reviewedAt: '2026-07-02T18:00:00.000Z', reviewStatus: SUBMISSION_STATUS.REVIEWED }],
      ...
      reviewMaterials: [linkAttachment('ha-4', 'Видеоразбор ошибки', 'https://example.com/review')], createdAt: '2026-06-29T08:00:00.000Z', updatedAt: '2026-07-02T18:00:00.000Z',
    },
    {
      id: 'hw-3', teacherId: TEACHER_ID, studentId: 's-3', title: 'Текстовые задачи', topic: 'Задание 21', taskNumbers: [21],
      assignedAt: '2026-07-01T08:00:00.000Z', dueAt: '2026-07-04T20:59:00.000Z', status: HOMEWORK_STATUS.OVERDUE, description: 'Переделать задачи на движение и проценты.',
      ...
      reviewMaterials: [], createdAt: '2026-07-01T08:00:00.000Z', updatedAt: '2026-07-01T08:00:00.000Z',
    },
    {
      id: 'hw-4', teacherId: TEACHER_ID, studentId: 's-2', title: 'Задания 6–8', topic: 'Задания 6, 7, 8', taskNumbers: [6, 7, 8],
      assignedAt: '2026-07-04T08:00:00.000Z', dueAt: '2026-07-09T20:59:00.000Z', status: HOMEWORK_STATUS.ASSIGNED, description: 'Тренировка заданий первой части по функциям и неравенствам.',
      solutionFile: '', submittedAt: '', reviewedAt: '', closedAt: '', attempts: [], teacherComment: '',
      materials: [libraryAttachment('ha-6', 7, 'Неравенства', 'Неравенства')],
      reviewMaterials: [], createdAt: '2026-07-04T08:00:00.000Z', updatedAt: '2026-07-04T08:00:00.000Z',
    },
  ],
  notifications: [
    { id: 'ntf-1', type: NOTIFICATION_TYPE.PROGRESS_ASSESSMENT_REQUIRED, status: NOTIFICATION_STATUS.UNREAD, teacherId: TEACHER_ID, studentId: 's-1', taskNumber: 7, lessonId: 'l-1', title: 'Оцените освоение задания 7', message: 'После занятия по заданию 7 нужно выставить уровень освоения для Ивана Петрова.', createdAt: '2026-07-05T16:30:00.000Z', resolvedAt: '' },
    { id: 'ntf-2', type: NOTIFICATION_TYPE.PROGRESS_ASSESSMENT_REQUIRED, status: NOTIFICATION_STATUS.UNREAD, teacherId: TEACHER_ID, studentId: 's-2', taskNumber: 6, lessonId: 'l-2', title: 'Оцените освоение задания 6', message: 'После занятия по заданию 6 нужно выставить уровень освоения для Марии Соколовой.', createdAt: '2026-07-06T15:30:00.000Z', resolvedAt: '' },
  ],
};
